...
class NetworkHandler:
    def __init__(self, server_data, config=ServerConfig):
        ...
        self.clients = {}
        self.message_handler = MessageHandler(self, server_data)
        self.running = False
        self.next_client_id = 1
        self.connection_handler = ConnectionHandler(self, self.message_handler)
